        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Breed_PetTypes_PetTypeId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Abyssian", 1 });

            migrationBuilder.InsertData(
                table: "Breed",
                columns: new[] { "Id", "Name", "PetTypeId" },
                values: new object[] { 2, "Maine Coon", 1 });

            migrationBuilder.InsertData(
                table: "Breed",
                columns: new[] { "Id", "Name", "PetTypeId" },
                values: new object[] { 3, "Ragdoll", 1 });

            migrationBuilder.InsertData(
                table: "Breed",
                columns: new[] { "Id", "Name", "PetTypeId" },
                values: new object[] { 4, "American Bulldog", 2 });

            migrationBuilder.InsertData(
                table: "Breed",
                columns: new[] { "Id", "Name", "PetTypeId" },
                values: new object[] { 5, "Chihuahua", 2 });

            migrationBuilder.InsertData(
                table: "Breed",
                columns: new[] { "Id", "Name", "PetTypeId" },
                values: new object[] { 6, "German Sheperd", 2 });
